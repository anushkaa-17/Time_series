...
def evaluate_model(original_price, p, differencing_order, q):
    try:
...
def get_best_arima_params(original_price, differencing_order, max_p=3, max_q=3):
    best_rmse = float("inf")
    best_p, best_q = 0, 0
    ...
    for p in range(max_p + 1):
        for q in range(max_q + 1):
            ...
            current_rmse = evaluate_model(original_price, p, differencing_order, q)
